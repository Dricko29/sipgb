        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Rw</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <form action="{{ route('rw.update', $rw) }}" method="POST" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control @error('nama_krw') is-invalid @enderror" id="nama_krw" name="nama_krw" value="{{ old('nama_krw', $rw->nama_krw) }}">
                                @error('nama_krw')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                ...
                                <input type="number" class="form-control @error('nik_krw') is-invalid @enderror" id="nik_krw" name="nik_krw" value="{{ old('nik_krw', $rw->nik_krw) }}">
                                @error('nik_krw')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                ...
                                @enderror" name="dusun_id">
                                    ...
                                    @foreach ($dusun as $item)
                                        @if (old('dusun_id', $rw->dusun_id) == $item->id)   
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="kontak" name="kontak" value="{{ old('kontak', $rw->kontak) }}">
                            </div>
                            <div class="col-md-12">
                                <label for="alamat" class="form-label">Alamat</label>
                                <input type="text" class="form-control" id="alamat" name="alamat" value="{{ old('alamat', $rw->alamat) }}">
                            </div>
