                ...
                <div class="card-body">
                        ...
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                    <a href="{{ route('rw.create') }}" class="btn btn-sm btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Tambah</a>
                                </div>
                            </div>
                        </div>
                        @endcan
                            ...
                            <table id="example" class="table align-middle dt-responsive table-nowrap" style="width:100%">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th>Nik Ketua Rw</th>
                                        <th>Jenis Kelamin</th>
                                        <th>Kontak Ketua Rw</th>
                                        <th>Alamat Ketua Rw</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->alamat }}</td>
                                        <td>
                                            <a href="{{ route('rw.show', $item) }}" class="btn btn-sm btn-success">lihat</a>
                                            @can('admin_akses')
                                                
                                            <a href="{{ route('rw.edit', $item) }}" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="{{ route('rw.destroy', $item) }}" method="POST" onsubmit="return confirm('anda yakin ?')" class="d-inline">
                                                @csrf
                                                @method('DELETE')
