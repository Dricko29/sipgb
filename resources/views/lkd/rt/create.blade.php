        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah RT Baru</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <form action="{{ route('rt.store') }}" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select mb-3" name="rw_id" id="sub_rw"></select>
                            </div>
                            <div class="col-md-6">
                                <label for="nama_krt" class="form-label">Nama Ketua RT</label>
                                <input type="text" class="form-control @error('nama_krt') is-invalid @enderror" id="nama_krt" name="nama_krt" value="{{ old('nama_krt') }}">
                                @error('nama_krt')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('nik_krt') is-invalid @enderror" id="nik_krt" name="nik_krt" value="{{ old('nik_krt') }}">
                                @error('nik_krt')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea rows="3" class="form-control" id="alamat" name="alamat" value="{{ old('alamat') }}"></textarea>
                            </div>
                    ...
                    success:function (data) {
                        if (data) {       
                            ...
                            $.each(data, function(key, subrws){
                                $('select[name="rw_id"]').append('<option value="'+ subrws.id +'">' +subrws.nama+ '</option>');
                            });
                        } else {
                            $('#sub_rw').empty();
                        }
