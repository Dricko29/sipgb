    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Status Kawin</h4>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Status Kawin</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="{{ route('kawin.create') }}" class="btn btn-sm btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Tambah</a>
                            </div>
                        </div>
                    </div>
                    @endcan
                            ...
                            <table id="example" class="table align-middle dt-responsive table-nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @can('admin_akses')
                                        <td>
                                            <a href="{{ route('kawin.edit', $item) }}" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="{{ route('kawin.destroy', $item) }}" method="POST" onsubmit="return confirm('anda yakin ?')" class="d-inline">
                                                @csrf
                                                @method('DELETE')
