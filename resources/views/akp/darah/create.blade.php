...
@section('title', 'Tambah Golongan Darah')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Golongan Darah Baru</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <form action="{{ route('darah.store') }}" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-12">
