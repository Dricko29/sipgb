        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Suku Baru</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <form action="{{ route('suku.store') }}" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="des" rows="3" name="deskripsi">{{ old('deskripsi') }}</textarea>
                            </div>                        
