        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Role | {{ $role->name }}</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                                    @forelse ($role->permissions as $item)
                                        <form action="{{ route('roles.revoke.permissions', [$role, $item]) }}" method="POST" onsubmit="return confirm('Anda yakin ?')">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('roles.give.permissions', $role) }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
