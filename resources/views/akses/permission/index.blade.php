...
@section('tite', 'Akses | Permissions')
                ...
                <div class="card-body">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                    <a href="{{ route('permissions.create') }}" class="btn btn-sm btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Tambah</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="example" class="table align-middle dt-responsive table-nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('permissions.roles', $item) }}" class="btn btn-sm btn-success">Role</a>
                                            <a href="{{ route('permissions.edit', $item) }}" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="{{ route('permissions.destroy', $item) }}" method="POST" onsubmit="return confirm('anda yakin ?')" class="d-inline">
                                                @csrf
                                                @method('DELETE')
