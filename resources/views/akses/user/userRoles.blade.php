        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">User Email : {{ $user->email }}</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                                    @forelse ($user->roles as $item)
                                        <form action="{{ route('users.remove.roles', [$user, $item]) }}" method="POST" onsubmit="return confirm('Anda yakin ?')">
                                            @csrf
                                            @method('DELETE')
