        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">User email : {{ $user->name }}</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                                    @forelse ($user->permissions as $item)
                                        <form action="{{ route('users.revoke.permissions', [$user, $item]) }}" method="POST" onsubmit="return confirm('Anda yakin ?')">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Permissions</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('users.give.permissions', $user) }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
                                    <label for="permission" class="form-label text-muted">Permissions</label>
                                    <select class="form-control" id="permission" name="permission" data-choices data-choices-sorting-false>
